...
reg add "HKLM\SOFTWARE\EB Playbook\Services%settingNameFeature%" /v days /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\SOFTWARE\EB Playbook\Services%settingNameQuality%" /v days /t REG_DWORD /d 0 /f >nul
