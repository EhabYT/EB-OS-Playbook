...
- 🔧 Integrates the [EB Tool](https://github.com/EhabYT/eb-tool) to customize your system further
- 🎮 Gaming & streaming optimizations with OBS Studio, StreamElements SE.Live, Discord, and Voicemeeter Banana

For more detailed information, see our documentation [here](https://ebos.cc/docs/features).

## 💻 System Requirements

EB Playbook currently supports ARM64 and AMD64 builds of the following Windows versions:
...
1. Download [AME Wizard](https://amelabs.net) and our playbook from the latest [releases](https://github.com/EhabYT/EB-OS-Playbook/releases).
...
- [Playbook](https://ebos.cc/docs/playbook/install)
- [ISO Injection](https://ebos.cc/docs/playbook/iso)
- [Troubleshooting](https://ebos.cc/docs/faq/troubleshoot/cannot-login)
...
EB Playbook is licensed under [Attribution-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/).
...
> [!NOTE]
> EB itself (and its Discord server) is not tech support in any shape or form.
